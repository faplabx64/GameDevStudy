...
const Rect kBaseImage   = Rect({ kPixelsPerCell * 19, 2 * kPixelsPerCell, kPixelsPerCell, kPixelsPerCell });
...
const Rect kBuffTank  = Rect({ kPixelsPerCell * 21, kPixelsPerCell * 7, kPixelsPerCell, kPixelsPerCell });